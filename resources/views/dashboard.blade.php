            ...
            <div class= "mt-8 text-gray-900">
                <div class="p-4 ">
                    @foreach ($posts as $post)
                        <div
                            class="flex mb-8 pl-8 border border-default rounded-base shadow-xs">
                          <div class="flex-1">
                            <a href="#">
                            ...
                            <a href="#"
                               ...
                               <a href="#">
                                <img class="rounded-r-lg h-full object-cover w-48" src="https://flowbite.com/docs/images/blog/image-1.jpg" alt="" class=""/>
                            </a>
                        </div>
